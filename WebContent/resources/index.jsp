...
<body id="page-top">
	...
	<c:import url="/resources/navbar.jsp"/>
        ...
        <h4>Olá ${empresaLogada.email}. Seja bem-vindo(a) ao Protocoli.</h4>
        <br>
        <h5>Utilize a barra de navegação ao lado para acessar as empreas, clientes, protocolos e itens cadastrados no sistema.</h5>
        <h5>Utilize a barra de navegação acima para sair do sistema.</h5>
      </div>
    </div>
  <!-- /#wrapper -->
